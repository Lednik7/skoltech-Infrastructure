...
class FPNMOCO(AbstractModel):
    def __init__(self, weights_path: str, device: str = "cuda"):
        super().__init__()
        self.device = device
        self.model = smp.FPN(encoder_name="resnet50", encoder_weights=None,
...
class FPNMOCOEnsemble(AbstractModel):
    def __init__(self, weights_paths: list, device: str = "cuda"):
        ...
        for weights_path in weights_paths:
            self.models.append(
                FPNMOCO(weights_path=weights_path, device=device))
